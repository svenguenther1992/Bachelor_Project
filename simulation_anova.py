...
Original file is located at
    https://colab.research.google.com/drive/1pTsdMST-gEopQEbSA3RuSf0Icy2AaTan
"""
import pandas as pd
import numpy as np
...
"""### **One-Way ANOVA Simulation Code (Final)**"""
...
#Iterative Simulation Run
distribution = ["normal", "skewed"]
std_dev = [[0.5, 0.5, 0.5], [1, 1, 1], [0.5, 0.5, 1]]
sample_sizes = [20, 50, 100]

simulation_dict = {}
simulation_dict["Distribution"] = []
simulation_dict["Std. Dev."] = []
simulation_dict["Sample Size"] = []
simulation_dict["ANOVA"] = []
simulation_dict["Welch"] = []
...
for a in distribution:
  for b in range(len(std_dev)):
    for c in sample_sizes:
      ...
      simulation_dict["Distribution"].append(a)

      simulation_dict["Std. Dev."].append(std_dev[b])

      simulation_dict["Sample Size"].append(c)
